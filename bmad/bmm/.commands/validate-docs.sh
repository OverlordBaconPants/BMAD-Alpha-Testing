#!/bin/bash
# Auto-generated command wrapper for validate-docs

workflow_path="/home/bj/python/BMAD-METHOD/bmad/bmm/workflows/validate-docs/workflow.yaml"
...
echo "Running validate-docs workflow..."
echo "Project: ${1:-$(pwd)}"
