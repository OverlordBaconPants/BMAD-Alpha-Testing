#!/bin/bash
# Auto-generated command wrapper for generate-api-docs

workflow_path="/home/bj/python/BMAD-METHOD/bmad/bmm/workflows/generate-api-docs/workflow.yaml"
...
echo "Running generate-api-docs workflow..."
echo "Project: ${1:-$(pwd)}"
