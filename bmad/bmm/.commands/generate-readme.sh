#!/bin/bash
# Auto-generated command wrapper for generate-readme

workflow_path="/home/bj/python/BMAD-METHOD/bmad/bmm/workflows/generate-readme/workflow.yaml"
...
echo "Running generate-readme workflow..."
echo "Project: ${1:-$(pwd)}"
